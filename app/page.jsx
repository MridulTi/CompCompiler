    ...
    <>
      ...
      <section className="w-full bg-gradient-to-b from-cyan-500 to-gray-100 h-screen grid place-items-center">
        <div className="grid place-items-center w-full text-gray-100">
          ...
          <Link href="/code/authentication"><ShimmerButton className="px-10 py-4 font-bold text-lg mt-6 rounded-full flex gap-2 hover:text-white hover:bg-black">Let's Compete <LuBinary className="text-4xl" /></ShimmerButton></Link>
        </div>
      </section>
    </>
  );
